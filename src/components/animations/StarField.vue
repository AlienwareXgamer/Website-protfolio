...
class Star {
  ...
  draw(ctx) {
    const x =
      (this.x - this.canvas.width / 2) * (200 / this.z) + this.canvas.width / 2;
    const y =
      (this.y - this.canvas.height / 2) * (200 / this.z) +
      this.canvas.height / 2;

    const prevX =
      (this.x - this.canvas.width / 2) * (200 / this.prevZ) +
      this.canvas.width / 2;
    const prevY =
      (this.y - this.canvas.height / 2) * (200 / this.prevZ) +
      this.canvas.height / 2;
