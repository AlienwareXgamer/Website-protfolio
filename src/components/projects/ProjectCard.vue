    ...
    <div class="project-header">
      ...
      <div class="project-links" v-if="project.links">
        <a v-for="link in project.links" 
           ...
           :title="link.title">
          <svg v-if="link.type === 'github'" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
          ...
          <svg v-else-if="link.type === 'demo'" width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
